...
{
    [ObservableProperty] public required partial ApplicationPageNames PageName { get; set; }

    [ObservableProperty] public required partial ApplicationPageNames SideBarSelectedPage { get; set; }
